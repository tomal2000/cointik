                                ...
                                <h5 class="card-title">Your Assets
                                    ...
                                    <div class="text-center">
                                        <form action="{{ route('trade.confirm') }}" method="POST">
                                            ...
                                            <button type="submit" class="btn btn-primary submit_btn">Confirm</button>
                                            <button type="reset" class="btn btn-secondary">Reset</button>
                                        </form>
                                        <form action="{{ route('trade.confirm') }}" id="requote_form" method="POST" class="d-none">
                                            @csrf
                                            <input type="hidden" name="id" value="{{ $order->id }}">
                                            <input type="hidden" name="type" value="requote">
